...
def char_maps(text: str):
    ...
    # ====== YOUR CODE: ======
    text_clean = sorted(''.join(set(text))) # sort and remove duplicates
    char_to_idx = {text_clean[i]:i for i in range(len(text_clean))}
    idx_to_char = {i:text_clean[i] for i in range(len(text_clean))}
    # ========================
...
def remove_chars(text: str, chars_to_remove):
    ...
    # ====== YOUR CODE: ======
    text_clean = text.translate({ord(x): '' for x in chars_to_remove})
